...
Sᴏʀʀʏ ɪ ᴏɴʟʏ ᴡᴏʀᴋ ᴏɴ <a href=https://t.me/+eYWwkNUAKIQzMzNl>CɪɴᴇᴍᴀCᴏᴍᴘᴀɴʏ</a> Gʀᴏᴜᴘ. Nᴏ ᴏᴛʜᴇʀ ᴄᴏᴍᴍᴀɴᴅ ᴡɪʟʟ ᴡᴏʀᴋ ᴏɴ ᴛʜɪs ʙᴏᴛ ᴇxᴄᴇᴘᴛ sᴛᴀʀᴛ. ᴅᴏɴ’ᴛ ᴡᴀsᴛᴇ ʏᴏᴜʀ ᴛɪᴍᴇ</b>"""
    ...
    DATE_TXT = """Group Message Delete After A certain Time Period cause copyright infringement ⌛️

📵 Powered By cenEma9.t.me"""
    HELP_TXT = """<b>𝙷𝙴𝚈 {}
...
• /connections - <code>list all your connections</code>"""
    ...
    EXTRAMOD_TXT = """<b>⍟───[ ᴏᴡɴᴇʀ ᴅᴇᴛᴀɪʟꜱ ]───⍟
    
• ꜰᴜʟʟ ɴᴀᴍᴇ : ロブ･ルッチ
• Uꜱᴇʀ ɴᴀᴍᴇ : @GxNeo
• Usᴇʀ ɪᴅ : 1067513987

∂σи'т вє αfяαι∂ σf вєιиg ∂ιffєяєит, вє αfяαι∂ σf вєιиg тнє ѕαмє αѕ єνєяуσиє єℓѕє</b>"""
...
• U𝚂𝙴ᴅ S𝚃𝙾𝚁𝙰𝙶𝙴: <code>{}</code>
• F𝚁𝙴ᴇ S𝚃𝙾𝚁𝙰𝙶𝙴: <code>{}</code></b>"""
...
╔════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╗
▫️<a href=https://t.me/CmRips> ᴄʜᴀɴɴᴇʟ </a>

▫️<a href=https://t.me/cenEma9> sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ </a>
╚════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╝</b>"""
...
𝖤𝗑𝖺𝗆𝗉𝗅𝖾 :- <code>/country India</code>"""
    SPELL_CHECK_MAYR = """𝖧𝖾𝗒 𝗒𝗈𝗎 𝖼𝖺𝗇'𝗍 𝗋𝖾𝗊𝗎𝖾𝗌𝗍 𝗆𝗈𝗏𝗂𝖾𝗌 𝗂𝗇 𝗆𝗒 𝖯𝖬 𝖻𝖾𝖼𝖺𝗎𝗌𝖾 𝗆𝗒 𝖺𝖽𝗆𝗂𝗇 𝖻𝗅𝗈𝖼𝗄𝖾𝖽 𝗆𝗒 𝖯𝖬 𝗉𝖾𝗋𝗆𝗂𝗌𝗌𝗂𝗈𝗇 𝖻𝖾𝖼𝖺𝗎𝗌𝖾 𝗍𝖾𝗅𝖾𝗀𝗋𝖺𝗆 𝖼𝗈𝗉𝗒𝗋𝗂𝗀𝗁𝗍 𝗏𝗂𝗈𝗅𝖺𝗍𝗂𝗈𝗇 𝗂𝗌 𝖺𝖿𝖿𝖾𝖼𝗍𝗂𝗇𝗀 𝗍𝖾𝗅𝖾𝗀𝗋𝖺𝗆 𝖻𝗈𝗍𝗌 𝗇𝗈𝗐 𝗌𝗈 𝗉𝗅𝖾𝖺𝗌𝖾 𝗋𝖾𝗊𝗎𝖾𝗌𝗍 𝗆𝗈𝗏𝗂𝖾𝗌 𝗂𝗇 𝗆𝗒 𝗀𝗋𝗈𝗎𝗉 𝖨 𝗐𝗂𝗅𝗅 𝗐𝗈𝗋𝗄 𝗉𝗋𝗈𝗉𝖾𝗋𝗅𝗒 𝗂𝗇 𝗆𝗒 𝗀𝗋𝗈𝗎𝗉\n\nഹേയ് നിങ്ങൾക്ക് എന്റെ പിഎമ്മിൽ സിനിമകൾ അഭ്യർത്ഥിക്കാൻ കഴിയില്ല, കാരണം എന്റെ അഡ്മിൻ എന്റെ പിഎം അനുമതി തടഞ്ഞു, കാരണം ടെലിഗ്രാം പകർപ്പവകാശ ലംഘനം ഇപ്പോൾ ടെലിഗ്രാം ബോട്ടുകളെ ബാധിക്കുന്നു, അതിനാൽ ദയവായി എന്റെ ഗ്രൂപ്പിലെ സിനിമകൾ അഭ്യർത്ഥിക്കുക ഞാൻ എന്റെ ഗ്രൂപ്പിൽ ശരിയായി പ്രവർത്തിക്കും"""
