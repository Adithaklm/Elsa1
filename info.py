...
NOR_IMG = environ.get('NOR_IMG', "https://te.legra.ph/file/471172796da37b50f4f4f.jpg")
...
AUTH_CHANNEL_LINK = environ.get('AUTH_CHANNEL_LINK', '-1003916189714')
...
FILE_FORWARD = environ.get('FILE_FORWARD',"https://t.me/files004")
MSG_ALRT = environ.get('MSG_ALRT', '𝑪𝑯𝑬𝑪𝑲 & 𝑻𝑹𝒀 𝑨𝑳𝑳 𝑴𝒀 𝑭𝑬𝑨𝑻𝑼𝑹𝑬𝑺')
# Accept either a numeric Telegram chat ID or a resolvable username/link.
# A username is important for a fresh bot session because Telegram requires
# an access_hash to resolve a channel peer from its numeric ID.
FILE_CHANNEL = parse_peer(environ.get('FILE_CHANNEL', '-1002148139463'))
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002123643586').split()]
FILE_INFO_CHANNEL = parse_peer(environ.get('FILE_INFO_CHANNEL', '-1003847081713'))
